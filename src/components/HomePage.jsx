        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <p className="text-gray-300">© 2025 TENNsational.com. All rights reserved.</p>
            </div>
            <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0">
              <div className="flex space-x-6 md:mr-8">
                ...
                <a href="mailto:Admin@tennsational.com" className="text-gray-300 hover:text-white transition-colors">
                  Contact Us
                </a>
              </div>
